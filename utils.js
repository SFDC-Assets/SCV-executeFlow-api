...
const NON_FIELD_NAMES = ["methodName", "objectApiName","flowApiName", "recordId"];
...
function getFlowInputFieldValuesFromConnectLambdaParams(params) {
  const fieldValues = {};
  ...
  const inputs = {"inputs": [fieldValues]};
  return inputs;
}
...
module.exports = {
  ...
  getFlowInputFieldValuesFromConnectLambdaParams
};
